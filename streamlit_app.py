...
def main() -> None:
    ...
    with tab1:
        render_section_header(
            "Repository Registry", "Selective integration of local reference repositories."
        )
    ...
    with tab2:
        render_section_header(
            "Data Quality", "Current governed checks for the sample analytical surface."
        )
        ...
        render_section_header(
            "Semantic Metrics Catalog", "Definitions and domain rollups used by the platform."
        )
    ...
    with tab3:
        render_section_header(
            "GenAI Insight Layer",
            "Analytics-oriented drafts generated by a provider-agnostic service.",
        )
    ...
    with tab4:
        render_section_header(
            "Observability Event", "Latest structured event emitted by the pipeline."
        )
