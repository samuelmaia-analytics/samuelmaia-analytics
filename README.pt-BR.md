...
# Samuel Maia | Portfólio de Analytics
...
Baseado em Fortaleza, Brasil. Aberto a oportunidades remotas e projetos freelance de dados.
...
- Controles básicos de qualidade e governança
...
Suite de analytics com métricas de negócio, qualidade de dados e visão de apoio à decisão.
...
Projeto analítico com documentação de governança e fluxo de publicação de dados.
...
### 4) Churn Prediction
Projeto de retenção com scoring e saídas orientadas à ação.
...
## Nota para recrutadores e leads
- Estou aberto a vagas júnior e intermediárias em Dados e BI.
