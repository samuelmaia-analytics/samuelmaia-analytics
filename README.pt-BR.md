...
Sou profissional de dados, resido em Fortaleza/CE e atuo na construção de soluções analíticas que conectam dados, negócio, qualidade e tomada de decisão.
...
Ajudo equipes a sair de relatórios soltos e bases pouco confiáveis para uma estrutura analítica mais organizada, documentada e pronta para apoiar decisões.
...
- construir dashboards e aplicações analíticas para consumo gerencial;
...
| Dashboards e Produtos Analíticos | Power BI, Streamlit, indicadores de performance, leitura gerencial e visualização orientada a negócio |
...
**Foco:** governança analítica, qualidade de dados, documentação, LGPD e consumo gerencial.

Projeto com abordagem inspirada em ambiente de produção, demonstrando organização de ativos analíticos, verificações de qualidade, documentação, governança e camada de consumo gerencial.

**Por que este projeto é relevante:** mostra uma preocupação além do dashboard, tratando dados como produto confiável, com regras, validações, rastreabilidade e documentação.
...
**Foco:** analytics de receita, performance, retenção e apoio à decisão.

Solução voltada à leitura de receita e performance, com visão gerencial para acompanhar indicadores, priorizar riscos e apoiar decisões comerciais.
...
**Foco:** pipeline ponta a ponta, analytics com Machine Learning e saídas documentadas.
...
Central de controle operacional com regras de negócio, indicadores de risco, priorização e leitura gerencial.
...
**Por que este projeto é relevante:** demonstra capacidade de resolver um desafio técnico de ponta a ponta, com estrutura, clareza analítica e preocupação com governança.
...
| Data Senior Analytics | app analítico com KPIs curados e leitura gerencial | https://github.com/samuelmaia-analytics/data-senior-analytics | https://data-analytics-sr.streamlit.app/ | público |
...
- **Comunicação com negócio:** foco em dashboards e narrativas que conectam dados a decisões reais.
- **Experiência comercial:** vivência com liderança, treinamento, negociação, atendimento e acompanhamento de performance.
...
- Construção e organização de indicadores de desempenho para análises operacionais e gerenciais.
...
- Apoio a análises exploratórias, conferências de dados, fluxos de relatórios e estruturação de informações operacionais.

### Líder Comercial e Consultor de Vendas Independente | Up Essência | 2021-2024
- Atuação com vendas diretas, abordagem de clientes, negociação, relacionamento e acompanhamento de performance comercial.
- Treinamento de consultores independentes em apresentação de produtos, objeções, comunicação e fechamento.
...
- Desenvolvimento de projetos ponta a ponta com ingestão, transformação, modelagem, validação, documentação, dashboards e publicação.
...
- Pós-graduação em Inovação e Transformação Digital — em andamento, conclusão prevista para 2026
...
- BI gerencial e dashboards orientados à decisão
...
Para visualizar uma cópia da licença, acesse:  
